          ...
          <div class="col-12 col-lg-4 d-flex justify-content-center justify-content-lg-end mt-4 mt-lg-0">
            <div class="calendar-card p-4">
              <div class="d-flex align-items-center justify-content-between mb-3">
                <h4 class="fw-bold mb-0" id="calendarMonthYear">April 2025</h4>
                <div>
                  <button class="btn btn-primary btn-sm me-1" id="prevMonthBtn"><i class="bi bi-chevron-left"></i></button>
                  <button class="btn btn-secondary btn-sm me-1" id="todayBtn">Today</button>
                  <button class="btn btn-primary btn-sm" id="nextMonthBtn"><i class="bi bi-chevron-right"></i></button>
                </div>
              </div>
              <table class="table table-borderless text-center mb-0 calendar-table" id="calendarTable">
                <thead>
